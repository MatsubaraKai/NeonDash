...
void Loader::LoadAllConeJsonFile(const std::string kDefaultBaseDirectory, const std::string fileName, const std::string sceneType, std::vector<Object3d*>& objects, Camera* camera)
{
    // フルパスを生成
    const std::string fullpath = kDefaultBaseDirectory + "/" + fileName + ".json";
...
void Loader::LoadAllStarJsonFile(const std::string kDefaultBaseDirectory, const std::string fileName, const std::string sceneType, std::vector<Object3d*>& objects)
{
    // フルパスを生成
    const std::string fullpath = kDefaultBaseDirectory + "/" + fileName + ".json";
